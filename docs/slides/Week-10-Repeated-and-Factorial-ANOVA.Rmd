...
There was a significant main effect of noise [*F*(1.98, 194.13) = 15.08, *p* < .001]. Test scores were significantly lower with loud noise (*M* = 5.79) than with no noise (*M* = 6.91; *p* < .001) or with quiet noise (*M* = 6.44; *p* = .005). There was no significant difference between the "no noise" and "quiet noise" conditions (*p* =.062).
...
Finally, there was also a significant interaction between Noise and Difficulty [*F*(1.98, 194.13) = 13.09, *p* < .001], see Figure X. Simple main effects analysis, corrected for multiple comparisons using Tukey's HSD, found that when test difficulty was Easy, there were no significant differences between any level of Noise (all *p*s > .58). However, in the Hard condition, test performance was significantly better when there was no noise (*M* = 6.25) compared to when there was either quiet (*M* = 5.11; *p* < .001) or loud noise (*M* = 4.08, *p* < .001). Performance was also significantly worse for loud noise relative to quiet noise (*p* = .002).
