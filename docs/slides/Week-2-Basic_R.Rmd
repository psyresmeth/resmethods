...
.right-pull[
![:scale 60%](images/00/default_project.png)
]
...
---
background-image: url(images/00/studio_blank.png)
background-size: contain
class: inverse

---
background-image: url(images/00/studio-create-script.png)
background-size: contain
class: inverse

---
background-image: url(images/00/studio-script-window.png)
background-size: contain
class: inverse

---
background-image: url(images/00/studio-examp-script.png)
background-size: contain
class: inverse

---
background-image: url(images/00/studio-script-run.png)
background-size: contain
class: inverse

---
background-image: url(images/00/studio-script-source.png)
background-size: contain
class: inverse

---
background-image: url(images/00/studio-sourced-script.png)
background-size: contain
class: inverse
...
---
background-image: url(images/00/cloud-rmarkdown.png)
background-size: contain
class: inverse

---
background-image: url(images/00/cloud-rmarkdown-install.png)
background-size: contain
class: inverse

---
background-image: url(images/00/cloud-rmarkdown-new.png)
background-size: contain
class: inverse

---
background-image: url(images/00/cloud-rmd-example.png)
background-size: contain
class: inverse

---
background-image: url(images/00/cloud-rmd-chunk-lab.png)
background-size: contain
class: inverse

---
background-image: url(images/00/cloud-rmd-click-run.png)
background-size: contain
class: inverse

---
background-image: url(images/00/cloud-rmd-chunk-play.png)
background-size: contain
class: inverse

---
background-image: url(images/00/cloud-rmd-click-knit.png)
background-size: contain
class: inverse

---
background-image: url(images/00/cloud-rmd-html-file.png)
background-size: contain
class: inverse
...
This is quite a common format. For example, each row could represent an individual participant, while each column could represent a different numerical measure.
...
Here I created a 3 x 3 matrix and then extracted the number from the 2nd row down, 3rd column across.
...
*Tabular* data is also a collection of different types of data, arranged in a rectangular, tabular format. Most of the data you encounter in psychology is in this kind of format.
