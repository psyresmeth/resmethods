...
t.test(FoC ~ victim_crime,
       ...
       paired = FALSE)
```
```{r inital-t-save, echo = FALSE}
t.test(FoC ~ victim_crime,
       data = crime,
       paired = FALSE) -> t_test_output
```
]
...
"**t = `r round(t_test_output$statistic, 3)`, df = `r round(t_test_output$parameter, 3)`, p-value = `r round(t_test_output$p.value, 3)`**"
...
"An independent sample *t*-test was conducted to test whether being victims (or not) victims of crime affect fear of crime. On average, participants who had been victims of crime did not have significantly higher Fear of Crime (*M* = 2.41, *SE* = .10) than participants who had not (*M* = 2.46, *SE* = .07), 
*t*(197.48) = .453, *p* = .651."
...
Remember to always specify, *somewhere*, what type of *t*-test you used.
