...
|------------------------------|
| ![A photograph of Dr Tochukwu Onwuegbusi](images/00/tochs2.jpg) |
...
.large[
We would like to invite you to complete the Research Method Skill Audit? This should take no longer than 4 minutes. The audit is important as it helps us to tailor our teaching and support to meet your learning needs. Just to confirm again my verbal clarification: all answers given are anonymous and are used to reflect on your statistical and programming skills, and for us to gauge what skills shortage need addressing so that we can help you to the best of our ability. Please use the link below to complete the short audit questionnaire! 
