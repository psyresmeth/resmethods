...
In the timetabled (lecture) sessions we will spend the first hour going over the topc for that week. In the second hour (workshop), you can spend the time working together on the exercises, and we'll be available to help out. You will finish up with a formative assignment for that week and receive a formative feedback.
